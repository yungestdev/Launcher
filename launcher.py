...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.news = requests.get("https://raw.githubusercontent.com/yungestdev/databaseLauncher/main/news.txt").content
